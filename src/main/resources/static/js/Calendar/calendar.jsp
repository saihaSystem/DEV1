...
<td bgcolor="#FEF7F0" align="center">
    ...
    <th scope="col"  width="20">일</th>
    <th scope="col" width="20">월</th>
    <th scope="col" width="20">화</th>
    <th scope="col" width="20">수</th>
    <th scope="col" width="20">목</th>
    <th scope="col" width="20">금</th>
    <th scope="col" width="20">토</th>
    </tr>
    <tr>
    ...
    <td colspan="7" align="center">
        오늘 <div id="CalendarToday" style="display:inline"></div>&nbsp;|
        <div id="CalendarClose" style="display:inline"><font color="green"><b>닫기</b></font></div></td>
    </tr>
    <tfoot></tfoot>
    </table>
</td>
